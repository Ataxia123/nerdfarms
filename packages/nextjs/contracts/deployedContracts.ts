          ...
          abi: [
            ...
            },
            {
              inputs: [
                ...
                { internalType: "bytes", name: "extensionInitData", type: "bytes" },
                { internalType: "address", name: "uniswapV3NonfungiblePositionManager", type: "address" },
                { internalType: "address", name: "rewardTokenAddress", type: "address" },
                { internalType: "bytes", name: "farmingSetupInfosBytes", type: "bytes" },
              ],
              name: "init",
