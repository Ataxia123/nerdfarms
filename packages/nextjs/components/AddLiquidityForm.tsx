...
function AddLiquidityForm(props: any) {
  ...
  //     functioName: functionNameToCall,
  //     args: args,
  //     value: ethValue,
  //   });
  ...
  //     args: [positionId],
  //   });
  //   const wargs = [positionId ? BigNumber.from(positionId) : "0x", pool.data ? pool.data.liquidity : "0"];
  //   const gasLimit = "500000";
  //   const { isLoading: withdrawLoading, writeAsync: withdrawAsync } = useScaffoldContractWrite({
  //     contractName: contractName,
  //     functionName: "withdrawLiquidity",
  //     args: [positionId ? BigNumber.from(positionId) : BigNumber.from("0x"), pool.data ? pool.data.liquidity : "0"],
  //   });
